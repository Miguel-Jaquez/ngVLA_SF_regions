...
subprocess.run(radmc_rl+' image lambdarange 2598.34 2600.94 nlam 60 incl 30 npix 3000 sizeau 2400 setthreads 14 ', shell=True, executable='/bin/bash')

os.system('mv image.out model_disk_line_incl30.out')


subprocess.run(radmc_rl+' image lambdarange 2598.34 2600.94 nlam 60 incl 90 npix 3000 sizeau 2400 setthreads 14 ', shell=True, executable='/bin/bash')

os.system('mv image.out model_disk_line_incl90.out')
