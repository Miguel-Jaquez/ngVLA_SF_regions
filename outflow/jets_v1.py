...
if GRID_construction == True:
    ...
    mdot = 5e-6*u.MSun_yr    # convierte masa solar por año a kg/s   ##va 1.5; 2 es para la propuesta   
    ...
    mdot = 5e-6*u.MSun_yr  # convierte masa solar por año a kg/s
    #---------------------
    #PHYSICAL PROPERTIES
    #---------------------
    r0=z_min
...
if RADMC_run == True:
    ...
    run_radmc(lines_df.iloc[i],GRID,finalprop,beam=(2e-3,2e-3),inclination=0)
